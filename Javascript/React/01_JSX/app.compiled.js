...
var animals = exports.animals = {
  dolphin: {
    image: 'pics/dolphin.jpg',
    facts: ['Dolphins have been shown to give distinct names to each other!', 'Dolphins are known to display their own culture!', 'Dolphins have two stomachs!']
  },
  lobster: {
    image: 'pics/lobster.jpg',
    facts: ['Lobsters taste with their legs!', 'Lobsters chew with their stomachs!', 'Lobsters can live as long as 100 years.']
  },
  starfish: {
    image: 'pics/starfish.jpg',
...
function displayFact(e) {
  ...
  var animalFacts = _animals.animals[name].facts;
  var optionIndex = Math.floor(Math.random() * animalFacts.length);
  var funFact = animalFacts[optionIndex];
